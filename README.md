...
## 📜 Сертификаты, обучение и подтвержденный опыт

* 🏆 **Test IO (An EPAM Company)** — **Certificate of Employment / Подтверждение опыта работы** 
  (В краудтестинге с ноября 2024 г.) — Успешно задокументировал **28 баг-репортов** (71% Acceptance Rate) и **426 репродукций багов** (89.7% Acceptance Rate). Подтверждены навыки блэк-бокс тестирования и составления качественной документации по стандартам EPAM.
